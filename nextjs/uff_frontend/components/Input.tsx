...
type InputType = 'email' | 'number' | 'password' | 'search' | 'tel' | 'text' | 'url' | DateType
    ...
    <span>
      ...
      <span
        className={clsx([
          ...
          // Invalid state
          (invalid) ? 'before:shadow-red-500/30 focus-within:before:shadow-none' : ''
        ])}
      >
        <input
          id={name}
          ...
          className={clsx([
            ...
            // Invalid state
            (invalid) ? 'border-red-500 hover:border-red-600 dark:border-red-500 dark:hover:border-red-400' : '',
