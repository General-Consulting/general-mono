  ...
  return (
    <thead>
      <tr>
        ...
        <TableTH key="Edit" className="text-center w-16">
          Edit
        </TableTH>
        <TableTH key="Delete" className="text-center w-12">
          Delete
        </TableTH>
      </tr>
    </thead>
...
export const TableBody = ({ tableData, onEdit, onDelete }: TableBodyProps) => {
...
export const Table = ({ tableData, onEdit, onDelete }: TableProps) => {
  return (
